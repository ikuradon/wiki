...
router.get('/login/gitlab', passport.authenticate('gitlab', { scope: ['read_user'] }))
...
router.get('/login/gitlab/callback', passport.authenticate('gitlab', { failureRedirect: '/login', successRedirect: '/' }))
